...
class AppTheme
{
  ...
  static Color appButtonprimaryColor = Color(0xFFE70D32);
  static Color appButtons = Color.fromRGBO(44, 100, 175, 1.0);



  static Color appButtonprimaryColorDark = Color(0xFFa7001c);

  static Color appButtonprimaryOpacityRed = Color.fromRGBO(
      231, 13, 50, 0.9333333333333333);
  ...
  static Color primaryOpacityColorCards = Color.fromRGBO(231, 13, 50, 0.09);
  ...
  static Color taskItemInstituto = Color(0xff413395);
